...
allHrs.forEach((element) => (element.style.border = "1px solid tomato"));

// Change the background of all the hr to "antiquewhite" using for of loop.

allHrs.forEach((element) => (element.style.backgroundColor = "antiquewhite"));

// Change the 'border-radius' of all the hr to "5px" using array.

allHrs.forEach((element) => (element.style.borderRadius = "5px"));
...
allHrs.forEach((element) => (element.style.borderStyle = "dashed"));
...
let para2 = document.querySelector(".three");
...
let allHrsbox = document.querySelectorAll(".box");
...
a1.hrf = "https://altcampus.school";
a2.hrf = "https://google.com";
